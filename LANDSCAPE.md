...
- **Popularity:** zero (just-published — v0.6.0 on PyPI/GitHub/GHCR, zero public stars). MCP leaders
...
- **A2A face perimeter-parity closed:** fail-closed public bind, bearer auth on the control endpoint,
  ...
  perimeter posture.
- **Maturity, stated straight:** v0.6.0, just-published (PyPI/GitHub/GHCR); a significant portion of the broader ~145-tool
