...
## 1. The tool count is real (715) — introspect it, don't read it
...
"buildSignerURI": ".github/workflows/release.yml@refs/tags/v0.24.0"
```
...
curl -s -o /dev/null -w '%{http_code}\n' \
  https://pypi.org/integrity/proximo-proxmox/0.24.0/proximo_proxmox-0.24.0-py3-none-any.whl/provenance
