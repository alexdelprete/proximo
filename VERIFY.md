...
## 1. The tool count is real (603) — introspect it, don't read it
...
"buildSignerURI": ".github/workflows/release.yml@refs/tags/v0.23.0"
```
...
curl -s -o /dev/null -w '%{http_code}\n' \
  https://pypi.org/integrity/proximo-proxmox/0.23.0/proximo_proxmox-0.23.0-py3-none-any.whl/provenance
