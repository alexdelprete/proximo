...
REVIEWED_TRUSTED: frozenset[str] = frozenset({
    'audit_verify', 'pbs_datastore_create', 'pbs_datastore_delete', 'pbs_datastore_get', 'pbs_datastore_status',
    ...
    'pbs_namespace_delete', 'pbs_namespaces_list', 'pbs_prune', 'pbs_realm_sync', 'pbs_remote_create',
    'pbs_remote_delete', 'pbs_remote_get', 'pbs_remote_update', 'pbs_remotes_list', 'pbs_snapshot_delete',
    'pbs_snapshot_notes_set', 'pbs_snapshot_protected_set', 'pbs_tasks_list', 'pbs_traffic_control_delete',
    'pbs_traffic_control_upsert', 'pbs_traffic_controls_list', 'pbs_verify_start', 'pdm_acl_list',
    'pdm_node_status', 'pdm_pbs_datastores_list', 'pdm_pbs_remote_status', 'pdm_pbs_snapshots_list', 'pdm_ping',
    'pdm_pve_cluster_status', 'pdm_pve_node_list', 'pdm_remote_config_get',
    ...
    'pve_acme_plugin_update', 'pve_agent_file_write', 'pve_agent_fs', 'pve_agent_set_password', 'pve_backup',
